...
class Meili_Admin_Page
{
    ...
    public function render_page_html()
    {
        ...
        <div class="wrap">
            ...
            <?php if (isset($_GET['message'])): ?>
                <div
                    class="notice notice-<?php echo strpos(urldecode($_GET['message']), 'Erro') === 0 ? 'error' : 'success'; ?> is-dismissible">
            ...
            <div style="margin-top: 20px; padding: 20px; background: #fff; border: 1px solid #ccd0d4;">
                ...
                <div id="meili-progress-container" style="display:none; margin-top: 15px;">
                    <div id="meili-progress-bar-wrapper" style="background-color: #ddd; border-radius: 4px; overflow: hidden;">
                        <div id="meili-progress-bar"
                            style="width: 0%; background-color: #0073aa; color: white; text-align: center; height: 25px; line-height: 25px; transition: width 0.5s;">
                            0%</div>
                    </div>
                    <div id="meili-progress-log"
                        style="margin-top: 10px; font-family: monospace; max-height: 200px; overflow-y: auto; background: #f3f3f3; padding: 10px; border-radius: 4px;">
                    </div>
                </div>
            </div>
        </div>
    ...
    {
        if (!isset($_POST['meili_action']) || !check_admin_referer('meili_admin_action_nonce'))
            return;
